...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (!empty($_FILES['image']['name'])) {
            ...
            $upload_dir = $_SERVER['DOCUMENT_ROOT'] . '/d/uploads/products/';
            ...
            if ($file_error !== UPLOAD_ERR_OK) {
                ...
                throw new Exception("Upload error: " . ($error_messages[$file_error] ?? 'Unknown error'));
            }
            ...
            $new_filename = 'prod_' . bin2hex(random_bytes(8)) . '.' . strtolower($ext);
            ...
            if (move_uploaded_file($tmp_name, $target_path)) {
                ...
                if (!empty($image_path) && strpos($image_path, 'http') === false) {
                    $old_image_path = $_SERVER['DOCUMENT_ROOT'] . $image_path;
                ...
                $image_path = '/d/uploads/products/' . $new_filename;
            } else {
        ...
        <?php if (!empty($product['image_path'])): ?>
            <div>
                ...
                <div class="flex items-center justify-center p-2 border border-gray-300 rounded-md">
                    ...
                    <img src="<?= 
                        (strpos($product['image_path'], 'http') === 0) 
