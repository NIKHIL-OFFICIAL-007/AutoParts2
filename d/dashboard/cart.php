          ...
          <?php foreach ($_SESSION['cart'] as $index => $item): ?>
            <div class="cart-item flex flex-col md:flex-row items-center py-6 border-b border-gray-100">
              <div class="flex-shrink-0 mb-4 md:mb-0">
                <img src="<?= htmlspecialchars($item['image'] ?? '../images/default-product.jpg') ?>" alt="<?= htmlspecialchars($item['name'] ?? 'Product') ?>" class="w-32 h-32 object-contain">
              </div>
              ...
              <div class="md:ml-6 flex-grow w-full">
                <div class="flex flex-col md:flex-row justify-between">
                  <div class="mb-4 md:mb-0">
                    ...
                    <p class="text-gray-600">Brand: <?= htmlspecialchars($item['brand'] ?? 'Unknown') ?></p>
