...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="relative">
        <input type="password" id="password" name="password"
            class="w-full px-3 py-2 border <?= isset($errors['password']) ? 'border-red-500' : 'border-gray-300' ?> rounded-md pr-10">
        <button type="button" toggle="#password" class="absolute inset-y-0 right-0 px-3 flex items-center toggle-password">
...
<div class="mb-4">
    ...
    <div class="relative">
        <input type="password" id="confirm_password" name="confirm_password"
            class="w-full px-3 py-2 border <?= isset($errors['confirm_password']) ? 'border-red-500' : 'border-gray-300' ?> rounded-md pr-10">
        <button type="button" toggle="#confirm_password" class="absolute inset-y-0 right-0 px-3 flex items-center toggle-password">
            <i class="fas fa-eye text-gray-500"></i>
        </button>
    </div>
