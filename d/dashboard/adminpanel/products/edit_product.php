...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_FILES['image']['name'])) {
        $uploadDir = '../../uploads/products/'; // Adjusted path
        ...
        if (!in_array($imageFileType, $allowedTypes)) {
            ...
            if (!empty($product['image_path']) && strpos($product['image_path'], 'uploads/products/') !== false) {
            ...
            $errors['image'] = 'Error uploading file. Please check directory permissions.';
        }
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="url" id="image_url" name="image_url" 
                            ...
                            value="<?= (strpos($product['image_path'], 'http') === 0) ? htmlspecialchars($product['image_path']) : '' ?>">
